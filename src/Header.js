    ...
    return(
      ...
      <div>
        <header id="header" className="alt">
          <span className="logo"><img src={avatar} alt=""></img></span>
          <h1>Krzysiek Kulig</h1>  
          <p>
          I am a Wroclaw University of Science and Technology graduate who is looking for first professional employment.
          My objective is to gain new abilities and experience in programming web applications. 
          I am interested in both backend and frontend aspects of code development.
          </p>
          <ul class="icons">
